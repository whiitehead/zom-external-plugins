...
public class TradePlugin extends Plugin
{
	...
	public void firstTradeScreen()
	{
		...
		String myTradeText = "You offer:<br>(Value: <col=ffffff>" + (myItemPrice == 1 ? "One" : myItemPrice) + "</col> " + (myItemPrice == 1 ? "coin" : "coins") + ")";

		String theirName = theirTradeOffer.getText().substring(0, theirTradeOffer.getText().indexOf(" offers:<br>"));
		String theirTradeText = theirName + " offers:<br>(Value: <col=ffffff>" + (theirItemsPrice == 1 ? "One" : theirItemsPrice) + "</col> " + (theirItemsPrice == 1 ? "coin" : "coins") + ")";
	...
	public void secondTradeScreen()
	{
		...
		String myTradeText = "You are about to give:<br>(Value: <col=ffffff>" + (myItemPrice == 1 ? "One" : myItemPrice) + "</col> " + (myItemPrice == 1 ? "coin" : "coins") + ")";
		String theirTradeText = "In return you will receive:<br>(Value: <col=" + (myItemPrice > theirItemsPrice ? RED_COLOR : WHITE_COLOR) + ">" + (theirItemsPrice == 1 ? "One" : theirItemsPrice) + "</col> " + (theirItemsPrice == 1 ? "coin" : "coins") + ")";
